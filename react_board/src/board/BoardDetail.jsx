...
function BoardDetail(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8080/board/boardDetail?idx=${boardIdx}`)
            .then(res => {
                const list = res.data;
    ...
    const handleEdit = () => {
        axios.put('http://localhost:8080/board/boardEdit', null, {
            params: {
                idx: boardIdx,
                title: title,
                updateId: updateId,
    ...
    const handleDelete = (e) => {
        axios.put('http://localhost:8080/board/boardDelete', null, {
            params: {
                idx: boardIdx
            }
        })
